--The data is in views from previous data warehouse project.  This will turn them into tables*/
...
--Combining the searches above into one table.  Last line was commented out, but remove the double dash if you want to look at it.
